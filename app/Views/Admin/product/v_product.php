                            ...
                            <tr>
                                ...
                                <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary mr-1" data-toggle="modal"
                                            data-target="#modalUpdate" data-id="<?= $product['id']; ?>"
                                        ...
                                        <button type="button" class="btn btn-sm btn-info view-btn" data-id=""
                                            data-toggle="modal" data-target="#modalImage"
                                            data-image="<?= base_url('show/product/' . $product['image']) ?>"
                                            data-description="<?= $product['description']; ?>"
                                            data-name="<?= $product['name']; ?>"><i class="fas fa-eye"></i></button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="description">Deskripsi</label>
                    <textarea name="description" class="form-control" id="description"
                        placeholder="Masukkan Deskripsi Produk" readonly></textarea>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#modalUpdate').on('show.bs.modal', function(event) {
        ...
        var categoryName = button.data(
        'category-name'); // Tidak ada input bernama categoryName di modal
